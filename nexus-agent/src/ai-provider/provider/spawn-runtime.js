 ...
 */
export function spawnRuntime({ command, args, workingDir, timeout, label, logDir, ticketKey, provider, prompt, artifactDir, onEvent, env = {}, stdinInput }) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (stdinInput) {
      proc.stdin.write(stdinInput, 'utf-8');
    }
    proc.stdin.end();
